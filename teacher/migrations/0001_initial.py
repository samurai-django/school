# Generated by Django 3.0.5 on 2020-05-11 13:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default=False, max_length=30, verbose_name='title')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='date')),
                ('content', models.CharField(default=False, max_length=255, verbose_name='content')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ManyToManyField(to='teacher.Class')),
            ],
        ),
    ]
